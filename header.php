...
$global_primary_phone_label   = ! empty( carbon_get_theme_option( 'tiu_primary_phone_label' ) ) ? carbon_get_theme_option( 'tiu_primary_phone_label' ) : ''; // phpcs:ignore
$global_primary_phone_number  = ! empty( carbon_get_theme_option( 'tiu_primary_phone' ) ) ? carbon_get_theme_option( 'tiu_primary_phone' ) : ''; // phpcs:ignore

 ...
 */
function theological_international_university_setup() {
	/*
...
add_action( 'after_setup_theme', 'theological_international_university_setup' );
 ...
 */
function theological_international_university_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'theological_international_university_content_width', 640 );
}
add_action( 'after_setup_theme', 'theological_international_university_content_width', 0 );
 ...
 */
function theological_international_university_widgets_init() {
	register_sidebar(
		array(
...
add_action( 'widgets_init', 'theological_international_university_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function theological_international_university_scripts() {
...
add_action( 'wp_enqueue_scripts', 'theological_international_university_scripts' );

...
class THEME_OPTIONS {
	...
	/**
	 * Class Theme Options Construct Function
	 */
	...
	public function crb_attach_theme_options() {
		...
		$main_theme_options_container = Container::make( 'theme_options', __( 'Theme Options', 'theological-international-university' ) )
			->add_tab(
				__( 'Styles', 'theological-international-university' ),
				array(
			...
			->add_tab(
				__( 'Contact Information', 'theological-international-university' ),
				array(
			...
			->add_tab(
				__( 'Socials', 'theological-international-university' ),
				array(

					...
					<div class="hero_slide">
						...
						<div class="hero_slide_container d-flex flex-column align-items-center justify-content-center">
							<div class="hero_slide_content text-center">
								<h1 data-animation-in="fadeInUp" data-animation-out="animate-out fadeOut"><?php echo wp_kses_post( $utilities->highlight_text_with_primary_color( $hero_slide_title ) ); ?></h1>
							</div>
						</div>
					</div>
				<?php

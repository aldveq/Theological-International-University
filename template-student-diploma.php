...
$diploma_magna_cum_laude_content         = pll_current_language('slug') === 'en' ?
carbon_get_theme_option('diploma_magna_cum_laude_content')
: carbon_get_theme_option('diploma_magna_cum_laude_content_es');
?>
<!--  Body Wrapper -->
    ...
    <div class="container-fluid student-diploma-wrapper">
        <div class="row">
            <div class="col-12">
                ...
                <?php
                if (
                    is_array($diploma_by_student_user_data)
                                ...
                                ?>
                                    <li class="nav-item" role="presentation">
                                        <button 
                                            ...
                                            id="<?php echo esc_attr(sanitize_title($ds_data['diploma_type'])); ?>-tab" 
                                            data-bs-toggle="tab" 
                                            data-bs-target="#<?php
                                                echo esc_attr(sanitize_title($ds_data['diploma_type']));
                                            ?>-tab-pane" 
                                            type="button" 
                                            role="tab" 
                                            aria-controls="<?php
                                        ...
                                        >
                                            <?php
                                                echo esc_html(
                                                    $utilities->get_diploma_spanish_tranlated_string(
                                                        $ds_data['diploma_type']
                                                    )
                                                );
                                            ?>
                                        </button>
                            ...
                            foreach ($diploma_by_student_user_data as $ds_data) :
                                if (0 === $tab_content_counter) :
                                    ...
                                    <div
                                        ...
                                        ?>-tab-pane" 
                                        role="tabpanel" 
                                        aria-labelledby="<?php echo
                                            esc_attr(sanitize_title($ds_data['diploma_type']));
                                        ?>-tab"
                                        tabindex="0"
                                    >
                                        <div class="row">
														...
														src="<?php
															echo esc_url(
																wp_get_attachment_image_url(
																	$ds_data['diploma_image'], 
																	'diploma_card_img_size', 
																	false
																)
															); 
														?>" 
                                            ...
                                            switch (sanitize_title($ds_data['diploma_type'])) :
                                                ...
                                                case 'chaplaincy':
                                                    ...
                                                    break;
                                                defult:
                                                    echo wp_kses_post(wpautop($diploma_magna_cum_laude_content, true));
                                                    break;
                                            endswitch;
                                            ?>
                                            </div>
